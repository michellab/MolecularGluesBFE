...
if species in ['BD1_only_bulk', 'BD2_IBG1withBD1_bulk', 'BD2_IBG1_only_bulk', 'BD1withBD2_IBG1_bulk']:
    prmtop_filename= 'BRD3_IBG1.prmtop'
    inpcrd_filename = 'BRD3_IBG1.inpcrd'

elif species == 'DCAF16': 
    prmtop_filename = 'DCAF16.prmtop'
    inpcrd_filename = 'DCAF16.inpcrd'    

elif species in ['DCAF16_only', 'BD1withDCAF16', 'BD2_IBG1withDCAF16andBD1', 'BD2_IBG1withDCAF16', 'BD1withDCAF16andBD2_IBG1', 'BD1_only', 'BD2_IBG1withBD1', 'DCAF16withBD1andBD2_IBG1', 'DCAF16withBD1', 'BD2_IBG1withDCAF16andBD1', 'BD2_IBG1_only', 'BD1withBD2_IBG1', 'DCAF16withBD1andBD2_IBG1', 'DCAF16withBD2_IBG1', 'BD1withDCAF16andBD2_IBG1']:
...
# Bulk state BD1 and BD2_IBG1 selections
if species in ['BD1_only_bulk', 'BD2_IBG1_only_bulk', 'BD1withBD2_IBG1_bulk', 'BD2_IBG1withBD1_bulk']:
    BD1_atoms = [
...
if species in ['DCAF16', 'DCAF16_only', 'BD1withDCAF16', 'BD2_IBG1withDCAF16andBD1', 'BD2_IBG1withDCAF16', 'BD1withDCAF16andBD2_IBG1', 
    'BD1_only', 'BD2_IBG1withBD1', 'DCAF16withBD1andBD2_IBG1', 'DCAF16withBD1', 'BD2_IBG1withDCAF16andBD1', 'BD2_IBG1_only', 
    'BD1withBD2_IBG1', 'DCAF16withBD1andBD2_IBG1', 'DCAF16withBD2_IBG1', 'BD1withDCAF16andBD2_IBG1']:
    receptor_atoms = [
        atom.index for atom in simulation.topology.atoms()
...
if 'BD1' in species:
    for atom in simulation.topology.atoms():
        ...
        if atom.index==BD1_atoms[-1] and atom.residue.name!='GLN':
            raise ValueError(f'Incorrect residue selection for BRD3 - residue THR280 is missing')
        
if 'BD2_IBG1' in species:
    for atom in simulation.topology.atoms():
...
# BD1 CV
if species in ['BD1_only_bulk', 'BD1withBD2_IBG1_bulk', 'BD1withDCAF16', 'BD1withDCAF16andBD2_IBG1', 'BD1_only', 
        'BD1withBD2_IBG1', 'BD1withDCAF16andBD2_IBG1']:
...
# BD2_IBG1 CV
elif species in ['BD2_IBG1withBD1_bulk', 'BD2_IBG1_only_bulk', 'BD2_IBG1withDCAF16andBD1', 'BD2_IBG1withDCAF16', 'BD2_IBG1withBD1',
        'BD2_IBG1withDCAF16andBD1', 'BD2_IBG1_only']:
    ligand_rmsd_force = mm.CustomCVForce('0.5*k_lig*(rmsd-rmsd_0)^2')
    ligand_rmsd_force.addGlobalParameter('rmsd_0', float(RMSD_0) * unit.angstrom)
    ligand_rmsd_force.addGlobalParameter('k_lig', k_RMSD * unit.kilocalories_per_mole / unit.angstrom**2)
    ligand_rmsd_force.addCollectiveVariable('rmsd', mm.RMSDForce(reference_positions, BD2_IBG1_atoms))
    system.addForce(ligand_rmsd_force)

# DCAF16 CV
elif species in ['DCAF16', 'DCAF16_only', 'DCAF16withBD1andBD2_IBG1', 'DCAF16withBD1', 'DCAF16withBD1andBD2_IBG1', 
        'DCAF16withBD2_IBG1']:
...
# BD1 restrained
if species in ['BD2_IBG1withBD1_bulk', 'BD2_IBG1withDCAF16andBD1', 'BD2_IBG1withBD1', 'DCAF16withBD1andBD2_IBG1', 'DCAF16withBD1', 
        'BD2_IBG1withDCAF16andBD1', 'DCAF16withBD1andBD2_IBG1']:
...
# BD2_IBG1 restrained
if species in ['BD1withBD2_IBG1_bulk', 'BD1withDCAF16andBD2_IBG1', 'DCAF16withBD1andBD2_IBG1', 'BD1withBD2_IBG1', 'DCAF16withBD1andBD2_IBG1', 
        'DCAF16withBD2_IBG1', 'BD1withDCAF16andBD2_IBG1' ]:
...
# DCAF16 restrained
if species in ['BD1withDCAF16', 'BD2_IBG1withDCAF16andBD1', 'BD2_IBG1withDCAF16', 'BD1withDCAF16andBD2_IBG1', 'BD2_IBG1withDCAF16andBD1',
        'BD1withDCAF16andBD2_IBG1']:
...
for i in range(sampling_steps//record_steps):
    ...
    if species in ['DCAF16', 'DCAF16_only', 'DCAF16withBD1andBD2_IBG1', 'DCAF16withBD1', 
        'DCAF16withBD1andBD2_IBG1', 'DCAF16withBD2_IBG1']:
        current_cv_value = receptor_rmsd_force.getCollectiveVariableValues(simulation.context)

    else: # BD1 or BD2_IBG1 CV
