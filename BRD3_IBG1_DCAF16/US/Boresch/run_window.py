...
inpcrd = app.AmberInpcrdFile('../equilibrated_structures/complex_NPT_eq.inpcrd')
...
for atom in simulation.topology.atoms():
    ...
    if atom.index==BD1_atoms[-1] and atom.residue.name!='GLN':
        raise ValueError(f'Incorrect residue selection for BD1 - residue Q280 is missing')
