...
if species == 'BD1':
    prmtop_filename= 'BD1.prmtop'
    inpcrd_filename = 'BD1.inpcrd'

elif species == 'DCAF16': 
    prmtop_filename = 'DCAF16.prmtop'
    inpcrd_filename = 'DCAF16.inpcrd'    

elif species in ['DCAF16_only', 'BD1_only', 'DCAF16withBD1', 'BD1withDCAF16']:
    prmtop_filename = 'complex_eq.prmtop'
    inpcrd_filename = 'complex_eq.inpcrd'

else:
    raise FileNotFoundError(f"Select one of the following options for species of interest: DCAF16, BD1, DCAF16_only, BD1_only, DCAF16withBD1, BD1withDCAF16")    
...
if species in ['DCAF16', 'DCAF16_only', 'DCAF16withBD1']:
...
if species in ['BD1', 'BD1withDCAF16', 'BD1_only']:
    for atom in simulation.topology.atoms():
        ...
        if atom.index==ligand_atoms[-1] and atom.residue.name!='THR':
            raise ValueError(f'Incorrect residue selection for BD1 - residue T107 is missing')

"""Applying RMSD forces"""

if species in ['BD1', 'BD1_only']:
...
for i in range(sampling_steps//record_steps):
    ...
    else: # BD1, BD2, BD1_only, BD1withDCAF16
