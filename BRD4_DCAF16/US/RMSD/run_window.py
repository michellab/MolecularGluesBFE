...
if species in ['BD1_only_bulk', 'BD2withBD1_bulk', 'BD2_only_bulk', 'BD1withBD2_bulk']:
    prmtop_filename= 'BRD4.prmtop'
    inpcrd_filename = 'BRD4.inpcrd'
...
if 'BD2' in species:
    for atom in simulation.topology.atoms():
        ...
        if atom.index==BD2_atoms[-1] and atom.residue.name!='ASP':
            raise ValueError(f'Incorrect residue selection for BRD4 - residue ASP391 is missing')
